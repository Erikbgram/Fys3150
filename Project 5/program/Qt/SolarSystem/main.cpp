...
int main() {
    ...
    */
    ...
    for(int i = 1; i < n; i++) {
        ...
        a_old(0) = a_scalar*(r_e(i-1,0)-r_s(0,0));
        a_old(1) = a_scalar*(r_e(i-1,1)-r_s(0,1));
        a_old(2) = a_scalar*(r_e(i-1,2)-r_s(0,2));
        ...
        a_new(0) = a_scalar*(r_e(i,0)-r_s(0,0));
        a_new(1) = a_scalar*(r_e(i,1)-r_s(0,1));
        a_new(2) = a_scalar*(r_e(i,2)-r_s(0,2));
        v_e(i,0) = v_e(i-1,0) + a_old(0)*dt + (a_new(0)+a_old(0))*(dt/2);
        v_e(i,1) = v_e(i-1,1) + a_old(1)*dt + (a_new(1)+a_old(1))*(dt/2);
        v_e(i,2) = v_e(i-1,2) + a_old(2)*dt + (a_new(2)+a_old(2))*(dt/2);
